...
export default function ConsultaPorcentagem() {
  ...
  return (
    <div className="min-h-screen bg-[#1e1e2f] text-white p-8 flex flex-col items-center">
      ...
      {resultado && (
        <div className="bg-[#2c2c3e] p-6 rounded-lg shadow-lg w-full max-w-md text-center">
          <h2 className="text-2xl font-bold mb-4">Resultado para: <span className="text-blue-400">{nomeCarta}</span></h2>
