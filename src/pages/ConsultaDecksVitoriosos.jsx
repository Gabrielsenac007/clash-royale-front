...
export default function ConsultaDecksVitoriosos() {
  ...
  const fetchDecks = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://clash-royale-80o9.onrender.com/batalhas/decks-vitoriosos?${params}`);
  ...
  return (
    <div className="relative min-h-screen text-white">
      {/* 🔲 Imagem de fundo */}
      <div className="absolute inset-0 bg-[url('/deckv.png')] bg-cover bg-center z-0"></div>
            ...
            {decks.map((deck, index) => (
              ...
              >
                ...
                <p className="text-lg mb-1">
                  🏆 Vitórias: <span className="font-semibold text-green-400">{deck.vitorias}</span>
                </p>
                <p className="text-lg mb-4">
                  📊 Porcentagem de Vitórias: <span className="font-semibold text-yellow-300">{deck.porcentagem}%</span>
                </p>
